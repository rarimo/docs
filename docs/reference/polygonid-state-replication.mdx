...
Users can check out how the state replication works using our demo DApp.
By leveraging the state replication, it lets users submit a Polygon ID zero-knowledge proof on Ethereum.
Users get an SBT as a reward.
...
Requests to the relayer should be performed using this url: https://api.mainnet-beta.rarimo.com
