...
The deposit functions are called when the user transfers his tokens from Solana to another network, while withdrawal functions are called when coins are transferred to Solana.

You can view our contracts directly on [github](https://github.com/rarimo/solana-bridge-program).
