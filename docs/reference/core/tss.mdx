...
The [tss-svc](https://gitlab.com/rarimo/tss/tss-svc) is a party implementation that is responsible for generating/resharing TSS keys and signing operations.
