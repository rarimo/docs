...
Responsible for the <OutLink href="https://github.com/rarimo/passport-zk-circuits/?tab=readme-ov-file#query-circuit-public-signals">query proof</OutLink> verification and pub signal validation.
...
- `vote()` — verifies query proof and call `vote()` function of `ProposalState` smart contract;
