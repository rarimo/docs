...
- **[ERC1155ETH.sol](https://github.com/rarimo/eip1155-eth/blob/main/contracts/ERC1155ETH.sol#L155)**1155ETH.sol</OutLink>**
  Shows how a contract gathers public signals and proof parameters before calling `verifyProof`.

- **[BioPassportVoting.sol](https://github.com/rarimo/passport-voting-contracts/blob/master/contracts/voting/BioPassportVoting.sol#L65)**tVoting.sol</OutLink>**
