...
- @rarimo/provider: Tools that provide access to wallets
- @rarimo/nft-checkout: Tools to get the estimated price of a transaction and to send transactions to Rarimo

## Prerequisites

- The SDK requires the [`ethers`](https://www.npmjs.com/package/ethers) package.

- To use the SDK, you must add the [Web3.js](https://web3js.org/) script to the page like this: `<script src="https://unpkg.com/web3@latest/dist/web3.min.js"></script>`.
This library provides access to browser-based wallets.
