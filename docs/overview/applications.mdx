...
Any data, asset, and functionality that is possible on a single blockchain will be unlocked for all users across chains.
We've already created one sub-protocol, which can safely lock and unlock assets across chains.
We are not limited by this one - and are already planning future sub-protocols to support future applications.
