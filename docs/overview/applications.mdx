...
Anything that is possible on a single blockchain will be unlocked for all dApps and users across chains.
We've already created one sub-protocol, which can safely lock and unlock tokens across chains.
