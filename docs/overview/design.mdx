...
Rarimo is the next-generation protocol offering cross-chain data, identity, and asset management.
We believe in a multichain future for web3, and designed our protocol to enable this future.
This gives our solution fundamental advantages over other cross-chain providers available today.
...
Rarimo is a cross-chain messaging protocol with a set of sub-protocols built on top.
