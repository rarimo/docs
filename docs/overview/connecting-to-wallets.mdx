...
For information about the wallets that the SDK supports and other things that you can do with wallet providers, see [Provider packages](../sdk/packages-provider).
