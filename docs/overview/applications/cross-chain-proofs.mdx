...
1. Call the deposit method on the bridge contract. For ERC721 [`depositERC721`](https://docs.rarimo.com/smart-contracts/interface/evm-reference#depositerc721), for ERC1155 [`depositERC1155`](https://docs.rarimo.com/smart-contracts/interface/evm-reference#depositerc1155). Note that you could specify some code that should be called on destination chain using [bundling feature](https://docs.rarimo.com/overview/bundling).
