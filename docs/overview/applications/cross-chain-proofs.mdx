...
1. Call the [`depositSBT`](https://rarimo.gitlab.io/docs/docs/smart-contracts/interface/evm-reference#depositsbt) method on the bridge contract. It checks the SBT ownership and triggers the corresponding event in the Rarimo Core.
