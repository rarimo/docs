...
1. The relayer sees the witness and sends a transaction to the Rarimo contract on the destination chain.
1. The Rarimo contract on the destination chain unlocks the equivalent tokens on the destination chain.
