...
Rarimo enables one-click cross-chain minting of NFTs.
...
1. Select the destination chain and receiver address in the application dapp;
...
Let's examine how the protocol works on a simple example: a Polygon User wants to mint an NFT and bridge it to Ethereum Mainnet:
