...
- [Creating transactions in JavaScript/TypeScript applications](#javascript)
- [Creating transactions with React components](#react-applications)
...
Now when the application loads, the `RarimoPayButton` appears on the page, as in this screenshot:
...
For information about the flow of the component that appear through the checkout process, see [`@rarimo/react-nft-checkout`](../sdk/react-nft-checkout).
