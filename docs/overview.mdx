...
- [Core concepts](./overview/design) | How the protocol works and how it is structured
- [Smart Contracts](./developers/contracts) | Rarimo's contracts on supported chains
