...
The crypto community strongly believes in a multichain future where each project brings its unique perspective and value proposition. However, this diversity introduces a plethora of interoperability, security, fragmentation, and other challenges. To address these issues, the Rarimo Protocol has been developed, serving as the base layer for decentralized interchain applications.
...
The protocol provides a general messaging protocol foundation for cross-chain use cases. Users can implement their own sub-protocols and submit them via the proposals mechanism. Rarimo offers ready-to-use [identity](/overview/identity) and [bridging](overview/bridge) sub-protocols.
...
The protocol and smart contracts have been audited by some of the industry's most trusted companies.
