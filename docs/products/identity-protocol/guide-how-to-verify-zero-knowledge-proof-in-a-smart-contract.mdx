...
We need to import the necessary [Rarimo identity contracts](https://github.com/rarimo/identity-contracts/tree/master) and inherit the [`BaseVerifier`](https://github.com/rarimo/identity-contracts/blob/aeb929ccc3fa8ab508fd7576f9fa853a081e5010/contracts/verifiers/BaseVerifier.sol) contract.
...
You can run the [Golang script](https://go.dev/play/p/rnrRbxXTRY6) to get schema hash and `claimPathKey` using your schema.
