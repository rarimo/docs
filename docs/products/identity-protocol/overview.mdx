...
<Image className="idealImage" img={require('/img/zkp.png')} alt="Cross-Chain Identity" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/identity-state-replication.png')} alt="Cross-Chain Identity" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/trust-triangle.png')} alt="Trust Triangle" shouldAutoDownload={() => true} />
