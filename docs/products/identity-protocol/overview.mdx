...
<p><Image img={require('/img/zkp.png')} alt="Cross-Chain Identity" /></p>
...
<p><Image img={require('/img/identity-state-replication.png')} alt="Cross-Chain Identity" /></p>
...
<p><Image img={require('/img/trust-triangle.png')} alt="Trust Triangle" /></p>
