...
<Image className="idealImage" img={require('/img/zkp.png')} alt="Cross-Chain Identity" />
...
<Image className="idealImage" img={require('/img/identity-state-replication.png')} alt="Cross-Chain Identity" />
...
<Image className="idealImage" img={require('/img/trust-triangle.png')} alt="Trust Triangle" />
