...
description: The Rarimo Identity Protocol is a cross-chain identity solution that enables users to prove their identity on any supported chain without compromising their privacy.
---
...
Rarimo’s [Proof of Humanity plugin](/ecosystem/proof-of-humanity) improves upon these solutions by aggregating identity providers and facilitating zero-knowledge identity proofs on-chain. This way, users can choose from many options for proving their humanity while keeping their privacy.
