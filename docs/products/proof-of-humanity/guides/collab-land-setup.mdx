---
slug: /products/proof-of-humanity/guides/protecting-your-discord-server-from-bots-with-proof-of-humanity-and-collab-land
...
1. Fill in the following fields and verify that the screenshot below matches your form:
   - Chain: `Polygon`;
   - Token Type: `ERC721`;
   - Addresses: `0xaD7De01cb7eaAFf3a419A0a0a3133a964cD90373`([reference](/products/proof-of-humanity/smart-contracts-reference#deployments));
...
1. Pin a messages that prompts your users to
