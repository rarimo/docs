...
description: Rarimo Protocol is a decentralized interchain messaging protocol.
---
...
To address these issues, the Rarimo Protocol has been developed, serving as the base layer for decentralized interchain applications.
...
Rarimo offers ready-to-use [identity](/products/identity-protocol) and [bridging](/products/bridging-protocol) sub-protocols.
