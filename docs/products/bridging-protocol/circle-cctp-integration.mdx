...
<Image className="idealImage" img={require('/img/USDC-NFT-Checkout.png')} alt="flow" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/USDC-ID.png')} alt="flow" shouldAutoDownload={() => true} />
