...
<IdealImage img={require('/img/bridging-flow.png')} alt="Bridging Flow" />
...
<IdealImage img={require('/img/token-agnostic-receipt.png')} alt="Token Agnostic Payments Example"/>
