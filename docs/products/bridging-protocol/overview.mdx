...
<Image className="idealImage" img={require('/img/bridging-flow.png')} alt="Bridging Flow" />
...
<Image  className="idealImage" img={require('/img/token-agnostic-receipt.png')} alt="Token Agnostic Payments Example" />
