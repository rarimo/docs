...
<!-- TODO: add a success screen with the SBT -->
...
<!-- TODO: add deployment and configuration instructions>
...
<!-- TODO: add instructions how to generate a QR-code -->

Let's go through the core business logic. For a start, we'll write a function that creates the request for the back-end service.
...
<!-- TODO: Add instructions for extending the logic -->