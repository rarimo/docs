...
<Image className="idealImage" img={require('/img/tokenomics.png')} alt="tokenomics" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/validator-rewards-time.png')} alt="rewards over time" shouldAutoDownload={() => true} />
