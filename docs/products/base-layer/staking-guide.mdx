...
<Image className="idealImage" img={require('/img/tokenomics.png')} alt="tokenomics" />
...
<Image className="idealImage" img={require('/img/validator-rewards-time.png')} alt="rewards over time" />
