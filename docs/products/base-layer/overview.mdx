...
<Image className="idealImage" img={require('/img/validator.png')} alt="Rarimo Base Layer" />
...
<Image className="idealImage" img={require('/img/protocol-layers.png')} alt="Rarimo Protocols" />
