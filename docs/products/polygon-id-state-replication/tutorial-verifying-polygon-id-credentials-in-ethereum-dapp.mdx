...
If you want to tweak or expand this example, we recommend you to clone [front-end](https://github.com/rarimo/web-client-polygonid/tree/main) and [smart contracts](https://github.com/rarimo/polygonid-integration-contracts) from the GitHub, make the changes you need and use it further.