...
1. The front-end creates the QR code with proof request from the user and shows it on the page.
...
1. After the successful verification, we mint an SBT for the user.
...
If you want to proceed further, we recommend you to clone the front-end from the [GitHub](https://github.com/rarimo/web-client-polygonid/tree/main), make the changes you need and use it for your purposes.