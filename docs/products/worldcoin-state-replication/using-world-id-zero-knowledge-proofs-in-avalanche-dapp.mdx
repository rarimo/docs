...
If you want to proceed further, we recommend you to clone the front-end from the [GitHub](https://github.com/rarimo/web-client-worldcoin-id/tree/main), make the changes you need and use it for your purposes.