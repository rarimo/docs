...
<Image className="idealImage" img={require('/img/rarime-levels-of-credentials-interoperability.png')} alt="Levels of credentials interoperability" shouldAutoDownload={() => true} />
