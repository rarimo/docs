---
slug: /ecosystem/passport-divided-profiles
description: Passport-derived profiles are a zero-knowledge solution that allows using biometric passports to verify your identity in DApps.
---
...
### Creating the password-derived profile
...
Users may revoke or change the identity management keypair, but this operation requires a password signature.
