...
As Vitalik Buterin outlined in [What do I think about biometric proof of personhood?](https://vitalik.eth.limo/general/2023/07/24/biometric.html), one of the most pressing challenges currently facing the web3 community, is how to provide Proofs-of-Humanity that are not only incontestable, but upholds the principle of web3 including privacy, decentralization and user-based ownership.

## How the solution works

Rarimo has achieved this by aggregating four identity providers: [Worldcoin](https://worldcoin.org/), [Unstoppable Domains](https://unstoppabledomains.com/), [Gitcoin Passport](https://passport.gitcoin.co/), [Kleros Proof of Humanity](https://proofofhumanity.id/) and [Civic](https://www.civic.com/).
