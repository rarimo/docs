...
<Image className="idealImage" img={require('/img/collabland-guide/sample-scam.png')} alt="Sample Scam" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/invite-bot.png')} alt="Invite Collab.Land Bot" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/role.png')} alt="Create a Role" shouldAutoDownload={() => true} />
...
1. Open the <OutLink href="https://cc.collab.land/login">Collab.Land Command Center</OutLink>:
   <Image className="idealImage" img={require('/img/collabland-guide/dashboard-login.png')} alt="Open Command Center" shouldAutoDownload={() => true} />
1. Log in via Discord:
   <Image className="idealImage" img={require('/img/collabland-guide/dashboard-login-discord.png')} alt="Login via Discord" shouldAutoDownload={() => true} />
1. Click on the **Marketplace** tab:
   <Image className="idealImage" img={require('/img/collabland-guide/marketplace.png')} alt="Marketplace" shouldAutoDownload={() => true} />
1. Install the **Rarimo Proof of Humanity Verify Action** by clicking on the **Free Install** button:
   <Image className="idealImage" img={require('/img/collabland-guide/install-action.png')} alt="Install Action" shouldAutoDownload={() => true} />

### Step #4: Set up a token-gating rule

1. Click on the **TGRs** tab in the Collab.Land console:
   <Image className="idealImage" img={require('/img/collabland-guide/tgr-tab.png')} alt="TGRs Tab" shouldAutoDownload={() => true} />
1. Click on the **Select Role** button:
   <Image className="idealImage" img={require('/img/collabland-guide/tgr-select-role.png')} alt="TGRs Select Role" shouldAutoDownload={() => true} />
1. Select the role you created in Step #1 and click **Apply**:
   <Image className="idealImage" img={require('/img/collabland-guide/select-role.png')} alt="TGRs Select Role" shouldAutoDownload={() => true} />
1. Fill in the following fields and verify that the screenshot below matches your form:
   ...
   - Addresses: `0xaD7De01cb7eaAFf3a419A0a0a3133a964cD90373`([reference](/ecosystem/proof-of-humanity/smart-contracts-reference#deployments));
     <Image className="idealImage" img={require('/img/collabland-guide/tgr-config.png')} alt="TGRs Config" shouldAutoDownload={() => true} />
1. Click **Save** and verify that you see the following screen:
   <Image className="idealImage" img={require('/img/collabland-guide/tgr-saved.png')} alt="TGRs Config Saved" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/create-human-channel.png')} alt="Create Human-Only Channel" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/join-instructions.png')} alt="Example of a message with verification isntructions" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/call-verify.png')} alt="Call /rarimo-verify" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/proof-of-humanity-dapp.png')} alt="Complete the Proof of Humanity Verification" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/collabland-guide/collabland-verify-asstes.png')} alt="Collab.Land Verify Assets" shouldAutoDownload={() => true} />
