...
<p><Image img={require('/img/collabland-guide/sample-scam.png')} alt="Sample Scam" /></p>
...
<p><Image img={require('/img/collabland-guide/invite-bot.png')} alt="Invite Collab.Land Bot" /></p>
...
<p><Image img={require('/img/collabland-guide/role.png')} alt="Create a Role" /></p>
...
1. Open the <OutLink href="https://cc.collab.land/login">Collab.Land Command Center</OutLink>:
   <p><Image img={require('/img/collabland-guide/dashboard-login.png')} alt="Open Command Center" /></p>
1. Log in via Discord:
   <p><Image img={require('/img/collabland-guide/dashboard-login-discord.png')} alt="Login via Discord" /></p>
1. Click on the **Marketplace** tab:
   <p><Image img={require('/img/collabland-guide/marketplace.png')} alt="Marketplace" /></p>
1. Install the **Rarimo Proof of Humanity Verify Action** by clicking on the **Free Install** button:
   <p><Image img={require('/img/collabland-guide/install-action.png')} alt="Install Action" /></p>

### Step #4: Set up a token-gating rule

1. Click on the **TGRs** tab in the Collab.Land console:
   <p><Image img={require('/img/collabland-guide/tgr-tab.png')} alt="TGRs Tab" /></p>
1. Click on the **Select Role** button:
   <p><Image img={require('/img/collabland-guide/tgr-select-role.png')} alt="TGRs Select Role" /></p>
1. Select the role you created in Step #1 and click **Apply**:
   <p><Image img={require('/img/collabland-guide/select-role.png')} alt="TGRs Select Role" /></p>
1. Fill in the following fields and verify that the screenshot below matches your form:
   ...
   - Addresses: `0xaD7De01cb7eaAFf3a419A0a0a3133a964cD90373`([reference](/ecosystem/proof-of-humanity/smart-contracts-reference#deployments));
     <p><Image img={require('/img/collabland-guide/tgr-config.png')} alt="TGRs Config" /></p>
1. Click **Save** and verify that you see the following screen:
   <p><Image img={require('/img/collabland-guide/tgr-saved.png')} alt="TGRs Config Saved" /></p>
...
<p><Image img={require('/img/collabland-guide/create-human-channel.png')} alt="Create Human-Only Channel" /></p>
...
<p><Image img={require('/img/collabland-guide/join-instructions.png')} alt="Example of a message with verification isntructions" /></p>
...
<p><Image img={require('/img/collabland-guide/call-verify.png')} alt="Call /rarimo-verify" /></p>
...
<p><Image img={require('/img/collabland-guide/proof-of-humanity-dapp.png')} alt="Complete the Proof of Humanity Verification" /></p>
...
<p><Image img={require('/img/collabland-guide/collabland-verify-asstes.png')} alt="Collab.Land Verify Assets" /></p>
