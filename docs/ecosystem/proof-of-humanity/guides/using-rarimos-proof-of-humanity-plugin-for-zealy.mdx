...
1. Create a helper quest that leads users to the Proof of Humanity DApp:
    ...
    <Image className="idealImage" img={require('/img/zealy-guide/step-1.png')} alt="Extra quest" />

1. Click on the **Mission** field:

    <Image className="idealImage" img={require('/img/zealy-guide/step-2.png')} alt="Mission field" />

1. Set the **Quest Type** field to **Empty**:

    <Image className="idealImage" img={require('/img/zealy-guide/step-3.png')} alt="Quest type" />

1. Turn on the **Auto-validate** toggle:

    <Image className="idealImage" img={require('/img/zealy-guide/step-4.png')} alt="Auto-validate" />
...
1. Put an instruction and the call-to-action link into the **Description** textbox:
    ...
    <Image className="idealImage" img={require('/img/zealy-guide/step-5.png')} alt="Instruction to visit the DApp" />
    ...
    <Image className="idealImage" img={require('/img/poh-greeting.png')} alt="Customized greeting" />

1. Publish the helper quest:

    <Image className="idealImage" img={require('/img/zealy-guide/step-6.png')} alt="Publishing the helper quest" />

1. Verify that the helper quest looks like this:

    <Image className="idealImage" img={require('/img/zealy-guide/step-7.png')} alt="Helper quest" />

1. Create your main quest:

    <Image className="idealImage" img={require('/img/zealy-guide/step-8.png')} alt="New quest creation" />

1. Select **NFT** in the  **Add Access** dropdown:

    <Image className="idealImage" img={require('/img/zealy-guide/step-9.png')} alt="NFT access condition" />

1. Click **Configure NFT**:

    <Image className="idealImage" img={require('/img/zealy-guide/step-10.png')} alt="Configure NFT" />
...
1. Put this address into the **Contract Address** field:
    ...
    <Image className="idealImage" img={require('/img/zealy-guide/step-11.png')} alt="Contract Address insertion" />

1. After you are done with the rest of the details for your quest, it should look like this:

    <Image className="idealImage" img={require('/img/zealy-guide/step-12.png')} alt="The final view" />
