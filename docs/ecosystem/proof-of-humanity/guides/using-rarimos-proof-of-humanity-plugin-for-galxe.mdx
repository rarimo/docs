...
1. Set up a new **Credentials Group**:
    ...
    <Image className="idealImage" img={require('/img/galxe-guide/step-1.png')} alt="New Credentials Group" shouldAutoDownload={() => true} />

2. Select the **On-Chain** type:

    <Image className="idealImage" img={require('/img/galxe-guide/step-2.png')} alt="Select type" shouldAutoDownload={() => true} />

3. Select the **Subgraph Credential**

    <Image className="idealImage" img={require('/img/galxe-guide/step-3.png')} alt="Subgraph Credential" shouldAutoDownload={() => true} />

4. Verify that you see this form:

    <Image className="idealImage" img={require('/img/galxe-guide/step-4.png')} alt="Verify the form" shouldAutoDownload={() => true} />
...
6. Verify that the filled form looks like this and hit **Save**:
   ...
   <Image className="idealImage" img={require('/img/galxe-guide/step-6.png')} alt="Verify and Save" shouldAutoDownload={() => true} />

7. Save the **Credential Group**:

   <Image className="idealImage" img={require('/img/galxe-guide/step-7.png')} alt="Save the Group" shouldAutoDownload={() => true} />
...
8. After you are done with the rest of the details for your campaign, you should see the Proof of Human step on the campaign page:
   ...
   <Image className="idealImage" img={require('/img/galxe-guide/step-8.png')} alt="Proof of Human step should be visible now" shouldAutoDownload={() => true} />
