...
See [LightweightStateV2.sol](https://github.com/rarimo/polygonid-integration-contracts/blob/master/contracts/LightweightStateV2.sol) for the full implementation.
...
See [QueryVerifier.sol](https://github.com/rarimo/polygonid-integration-contracts/blob/master/contracts/QueryVerifier.sol) for the full implementation.
...
See [VerifiedSBT.sol](https://github.com/rarimo/polygonid-integration-contracts/blob/master/contracts/VerifiedSBT.sol) for the full implementation.
