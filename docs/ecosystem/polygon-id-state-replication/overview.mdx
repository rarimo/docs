...
If you run an identity issuer for Polygon ID and want to enable the usage of ZKPs on Ethereum or another EVM-compatible network, follow this [guide](/ecosystem/polygon-id-state-replication/guide-how-to-set-up-polygon-id-state-replication).
