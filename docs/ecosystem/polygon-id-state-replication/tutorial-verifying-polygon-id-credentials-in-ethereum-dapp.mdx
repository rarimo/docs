...
See <OutLink href="https://devs.polygonid.com/docs/wallet/wallet-sdk/polygonid-sdk/iden3comm/auth-requests/">Polygon ID Wallet-SDK Docs</OutLink> for more details.
