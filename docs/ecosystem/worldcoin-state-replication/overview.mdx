...
<p><Image img={require('/img/world-id-state-bridge.png')} alt="World ID State Bridge" /></p>
...
<p><Image img={require('/img/world-id-state-replication-flow.png')} alt="World ID On-Demand Identity State Replication" /></p>
