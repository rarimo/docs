...
<Image className="idealImage" img={require('/img/world-id-state-bridge.png')} alt="World ID State Bridge" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/world-id-state-replication-flow.png')} alt="World ID On-Demand Identity State Replication" shouldAutoDownload={() => true} />
