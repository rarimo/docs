...
<p><Image img={require('/img/sdk/RarimoPayButton.png')} alt="The Rarimo pay button" /></p>
...
<p><Image img={require('/img/sdk/RarimoPayDialog-wallets.png')} alt="The Rarimo pay dialog, with an embedded list of wallets" /></p>
...
<p><Image img={require('/img/sdk/RarimoPayDialog-chains.png')} alt="The Rarimo pay dialog, with a list of chains" /></p>

When the user selects a chain, the dialog updates to show the tokens in the wallet in the `PaymentTokensList` component:

<p><Image img={require('/img/sdk/RarimoPayDialog-tokens.png')} alt="The Rarimo pay dialog, with an embedded list of tokens in the selected wallet and chain" /></p>
...
<p><Image img={require('/img/sdk/RarimoPayDialog-checkout.png')} alt="The Rarimo pay dialog, showing the selected token, the price conversion, and the fees" /></p>
