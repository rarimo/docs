...
<Image className="idealImage" img={require('/img/sdk/RarimoPayButton.png')} alt="The Rarimo pay button" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/sdk/RarimoPayDialog-wallets.png')} alt="The Rarimo pay dialog, with an embedded list of wallets" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/sdk/RarimoPayDialog-chains.png')} alt="The Rarimo pay dialog, with a list of chains" shouldAutoDownload={() => true} />

When the user selects a chain, the dialog updates to show the tokens in the wallet in the `PaymentTokensList` component:

<Image className="idealImage" img={require('/img/sdk/RarimoPayDialog-tokens.png')} alt="The Rarimo pay dialog, with an embedded list of tokens in the selected wallet and chain" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/sdk/RarimoPayDialog-checkout.png')} alt="The Rarimo pay dialog, showing the selected token, the price conversion, and the fees" shouldAutoDownload={() => true} />
