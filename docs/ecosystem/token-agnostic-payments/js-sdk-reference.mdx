...
For information about creating transactions, see <OutLink href="/ecosystem/token-agnostic-payments/guide-creating-nft-checkout-transactions">Creating NFT checkout transactions</OutLink>.
...
This package supports the same chain and wallet types as the <OutLink href="https://www.npmjs.com/package/@rarimo/provider">@rarimo/provider</OutLink> package and the chain-specific packages.
