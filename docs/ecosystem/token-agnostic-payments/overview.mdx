...
1. Open the demo page <OutLink href="https://nft-checkout.rarimo.com/">NFT Checkout demo</OutLink>
   ...
   <p><Image img={require('/img/token-agnostic-page.png')} alt="Token-agnostic page" /></p>

2. Click "Purchase with any token" and connect your Metamask

   <p><Image img={require('/img/token-agnostic-walletconnection.png')} alt="Token-agnostic wallet" /></p>

3. Select the token you want to pay with(in this case, it's UNI)

   <p><Image img={require('/img/token-agnostic-tokens.png')} alt="Token-agnostic tokens" /></p>

4. Check out the estimated fees and proceed to the checkout

   <p><Image img={require('/img/token-agnostic-receipt.png')} alt="Token-agnostic reciept" /></p>

5. Approve the token spending for the Rarimo swap contract

   <p><Image img={require('/img/token-agnostic-swap.png')} alt="Token-agnostic swap" /></p>

6. Confirm the swap of UNI to WETH

   <p><Image img={require('/img/token-agnostic-swap-confirm.png')} alt="Token-agnostic swap confirm" /></p>
...
7. …and, that's it! Rarimo Relayer will pick up the transaction and automatically complete the purchase of the NFT in the destination network
   ...
   <p><Image img={require('/img/token-agnostic-confirmation.png')} alt="Token-agnostic confirmation" /></p>
...
- [Customizable react component](/ecosystem/token-agnostic-payments/guide-creating-nft-checkout-transactions#react-applications)
  ...
  <p><Image img={require('/img/token-agnostic-button.png')} alt="Token-agnostic button for buying" /></p>
