...
> Give some examples of how bundles work
...
Make sure you pass in the correct spelling of the blockchain by using our [Get supported chain list endpoint]([API](../../api/reference/get-chain-list.api.mdx).
