...
Then, you will need to clone <a href="https://github.com/rarimo/issuer-node/tree/main" target="_blank" rel="noreferrer noopener">the repository</a> or download it <a href="https://github.com/rarimo/issuer-node/releases/tag/v1.0.0" target="_blank" rel="noreferrer noopener">manually</a>.
