...
1. Download the following:
  ...
  [APP file](https://storage.googleapis.com/rarimo-mainnet/core/app.toml) and
  [rarimo core binary file](https://storage.googleapis.com/rarimo-mainnet/core/rarimo-core)
...
1. Connect to our RPC node: `39072210913bb52a6444543ad160b04668d58210@34.66.205.183:26656`
...
1. Download the [broadcaster server binary](https://storage.googleapis.com/rarimo-mainnet/modules/broadcaster-svc)
...
1. Download (TSS service binary)[https://storage.googleapis.com/rarimo-mainnet/1.0.4/tss-svc]
