...
<!-- TODO: Does this link applies to World ID as well? -->
For more information about how the World ID identity state transfer works, visit [rarimo-core docs](https://github.com/rarimo/rarimo-core/blob/master/docs/common/bridging/002-identity.md).
...
<!-- todo: Hash state is just an example, as in Polygon ID Replication and maybe should be changed -->
```json
{
    "chain": "Sepolia",
    "hash": "0x24d76fbb1ba771df400f4d61d161a4a761675f14a2f35faf6d6d67e6d8be5fe6",
    "waitConfirm": true
}
```
