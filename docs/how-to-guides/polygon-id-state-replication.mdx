...
Or clone the  [repository](https://github.com/rarimo/relayer-svc) and build it from the source:

<!-- TODO: fix docker image -->

```sh
git clone git@github.com:rarimo/relayer-svc.git

#after changing clone link from gitlab to github checkout should be removed probably?
