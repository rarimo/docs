...
For more information about how the PolygonID identity state transfer works, visit [rarimo-core docs](https://github.com/rarimo/rarimo-core/blob/master/docs/common/bridging/002-identity.md).
...
Or clone the  [repository](https://gitlab.com/rarimo/polygonid/relayer-svc) and build it from the source:

<!-- TODO: fix docker image -->

```sh
git clone git@gitlab.com:rarimo/polygonid/relayer-svc.git
git checkout -b feature/submit-on-request # on-demand replication is not merged to the main yet
