...
To integrate it, redirect your users to the [PoH DApp](https://robotornot.rarimo.com/) to verify their humanity. Then, you can check their verification status using one of the following methods.
...
Contract Address: [0xaD7De01cb7eaAFf3a419A0a0a3133a964cD90373](https://polygonscan.com/address/0xaD7De01cb7eaAFf3a419A0a0a3133a964cD90373)
