...
1. Click on "All" category:

	![All tab](/img/questn-step-3.png)

1. Select the “Rarimo” template:

    ![Choosing  Rarimo template](/img/questn-step-4.png)

1. Check the "Proof of Humanity(PoH)" checkbox:

    ![Proof of Humanity Checkbox](/img/questn-step-5.png)

1. Verify that the filled form looks like this and hit “Save Settings”:

    ![Verify and save settings](/img/questn-step-6.png)

1. After you are done with the rest of the details for your quest, you should see the Proof of Humanity step on the quest page:

    ![Proof of Humanity step is visible now](/img/questn-step-7.png)