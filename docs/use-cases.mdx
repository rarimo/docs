...
For more information, see [Token-agnostic payments](./use-cases/nft-checkout).
...
For more information, see [Multi-chain NFT/credentials minting](./use-cases/minting).
...
For more information, see [Cross-chain staking](./use-cases/staking).
