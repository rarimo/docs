...
For more information, see [Token-agnostic payments](./use-cases/settlement-integration).
...
For more information, see [Cross-chain proofs](./use-cases/cross-chain-proofs).
...
For more information, see [Multi-chain NFT/credentials minting](./use-cases/cross-chain-minting).
...
For more information, see [Cross-chain staking](./use-cases/cross-chain-staking).
