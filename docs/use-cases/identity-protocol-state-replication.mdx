...
<p><Image img={require('/img/zkp.png')} alt="Replication flow in a nutshell" /></p>
...
<p><Image img={require('/img/polygon-eth-replication.png')} alt="State Replication flow from Ethereum to Polygon" /></p>
