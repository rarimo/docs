...
<Image className="idealImage" img={require('/img/zkp.png')} alt="Replication flow in a nutshell" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/polygon-eth-replication.png')} alt="State Replication flow from Ethereum to Polygon" shouldAutoDownload={() => true} />
