...
<Image className="idealImage" img={require('/img/social-graphs-links-scheme.png')} alt="Social Graphs links scheme" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/zkp.png')} alt="Social Graphs states circle scheme" shouldAutoDownload={() => true} />
