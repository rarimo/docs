...
<Image className="idealImage" img={require('/img/social-graphs-links-scheme.png')} alt="Social Graphs links scheme" />
...
<Image className="idealImage" img={require('/img/zkp.png')} alt="Social Graphs states circle scheme" />
