...
A combination of [threshold signature technology(TSS)](https://rarimo.gitlab.io/docs/docs/developers/tss/overview), instant finality, [EVM transaction bundling](https://rarimo.gitlab.io/docs/docs/overview/bundling), and low protocol fees make cross-chain interactions affordable and hassle-free for the end user.
