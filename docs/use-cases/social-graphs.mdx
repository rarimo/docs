...
<p><Image img={require('/img/social-graphs-links-scheme.png')} alt="Social Graphs links scheme" /></p>
...
<p><Image img={require('/img/zkp.png')} alt="Social Graphs states circle scheme" /></p>
