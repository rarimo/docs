...
<p><Image img={require('/img/zkp.png')} alt="Self-sovereign identity circle scheme" /></p>
...
<p><Image img={require('/img/identity-state-replication.png')} alt="Self-sovereign identity states scheme" /></p>
