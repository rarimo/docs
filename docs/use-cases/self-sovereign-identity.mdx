...
<Image className="idealImage" img={require('/img/zkp.png')} alt="Self-sovereign identity circle scheme" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('/img/identity-state-replication.png')} alt="Self-sovereign identity states scheme" shouldAutoDownload={() => true} />
