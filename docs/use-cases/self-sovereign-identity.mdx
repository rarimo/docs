---
# TODO: compe up with a better description
description: 'Use data in the web3 world using ZK-proofs for identity verification'
---
...
![Self-sovereign identity circle scheme](/img/zkp.png)
...
![Self-sovereign identity states scheme](/img/identity-state-replication.png)
