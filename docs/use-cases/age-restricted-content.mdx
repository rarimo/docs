...
<IdealImage img={require('/img/test21.png')} alt="Continue incognito button" />

**Step #2: User scans the QR code using RariMe App**

<IdealImage img={require('/img/test22.png')} alt="Scan QR code with RariMe" />

**Step #3: Generate and submit a proof of age**

<IdealImage img={require('/img/test2.png')} alt="Untitled" />

After clicking **Generate Proof**, the user confirms the generation of a zero-knowledge proof.
It may take from 30 secons to 1 minute to generate.

**Step #4: Browse the content while the session is valid**

<IdealImage img={require('/img/test23.png')} alt="Successfully verified" />
