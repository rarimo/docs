...
# Anonymous Age Verification for the Adult Entertainment Industry

## Problem statement

Adult entertainment sites have to be age-restricted to comply with regulations.
Giving the sensitive nature of the content, users feel uncomfortable creating an account or submitting any identifying documents on such sites.
...
In this case, they can confirm they are over eighteen without exposing their date of birth;
...
![Continue incognito button](/img/continue-incognito.png)

**Step #2: User connects MetaMask and RariMe snap**

![Connect MetaMask and RariMe](/img/connect-metamask-snap.png)

**Step #3: Generate and submit a proof of age**

![Untitled](/img/prove-the-age.png)

After clicking **Prove My Age** user confirms the generation of a zero-knowledge proof:

![Prove you are of legal age](/img/generate-age-zkp.png)

Then, the zero-knowledge proof generation starts.
It may take from 30s to 1 minute to generate, so it’s an ideal place to place interactive ads.

![Generating the zkp of legal age](/img/generating-age-proof-ads.png)
...
**Step #4: Enjoy the content while the session is valid**

![Enjoy age-restricted content](/img/enjoy-restricted-content.png)
