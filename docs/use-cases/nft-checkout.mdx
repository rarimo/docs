...
For a working demo of this use case, see the [NFT Checkout use case demo](https://nft-checkout.rarimo.com/).
...
For more information about transaction bundling, see [Bundling](../overview/bundling).
...
[NFT Checkout use case demo](https://nft-checkout.rarimo.com/)
