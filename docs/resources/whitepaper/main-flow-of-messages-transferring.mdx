...
<Image className="idealImage" img={require('./data-migration-flow.png')} alt="image" shouldAutoDownload={() => true} />
...
<Image className="idealImage" img={require('./protocol.png')} alt="Protocol Description" shouldAutoDownload={() => true} />
