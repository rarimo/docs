...
- Repo: [Saver Lib](gitlab.com/rarimo/savers/saver-grpc-lib)
- Repo: [EVM Saver](gitlab.com/rarimo/savers/evm-saver-svc)
- Repo: [Solana Saver](gitlab.com/rarimo/savers/solana-saver-svc)
- Repo: [Near Saver](gitlab.com/rarimo/savers/near-saver-svc)
...
4. After operation votes reaches `Quorum` (defined in `Gov` module) `rarimocore` calculates the voting power and vote results. To become `APPROVED` there should be at least `Threshold` (defined in `Gov` module) percentage positive votes.
